...
*/
const Dino = function(type, diet, weight, length, period){
  this.type = type, 
  this.diet = diet, 
  this.weight = weight, 
  this.length = length,
...
const tyrannosaurus = new Dino ("tyrannosaurus","carnivorous", "7000kg", "12m", "Late Cretaceous")
 
const stegosaurus = new Dino ("stegosaurus", "herbivorous", "2000kg", "9m", "Late Jurassic")

const velociraptor = new Dino ("velociraptor", "carnivorous", "15kg", "1.8m", "Late Cretaceous")
...
universitiess = []
let universities = graduates.forEach((graduate) => {
  universitiess.push(graduate.university)
})
...
*/
const populationTotal = zooAnimals.reduce((prev, cur) => {
